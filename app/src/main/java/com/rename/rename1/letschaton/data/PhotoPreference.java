...
public class PhotoPreference {
    ...
    private static final String GROUP_PHOTO = " com.rename.rename1.letschaton.data.KEY.GROUP_PHOTO" ;
    private static final String KEY_PHOTO = " com.rename.rename1.letschaton.data.KEY.KEY_PHOTO" ;
